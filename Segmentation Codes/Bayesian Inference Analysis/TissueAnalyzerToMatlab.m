...
if iscategorical(is_border_cell_plus_one) == 1
   rowDist = ones(1,length(is_border_cell_plus_one)) ;
   is_border_cell_plus_one = string(is_border_cell_plus_one);
   is_border_cell_plus_one = is_border_cell_plus_one == 'true';
   is_border_cell_plus_one = mat2cell(is_border_cell_plus_one,rowDist); 
end

if iscategorical(is_border_cell) == 1
   rowDist = ones(1,length(is_border_cell)) ;
   is_border_cell = string(is_border_cell);
   is_border_cell = is_border_cell == 'true';
   is_border_cell = mat2cell(is_border_cell,rowDist);   
